...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\MD_kW.py').read()) 
...
# Click Extended Resister  
pyautogui.click(x=55, y=391)
time.sleep(1)

# Click MD_kW
pyautogui.click(x=148, y=403)
time.sleep(1)
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'MD_kW.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'MD_W', 'data_type']
