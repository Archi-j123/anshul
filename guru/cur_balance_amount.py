...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\cur_balance_amount.py').read()) 
...
# Click cur_balance_amount
pyautogui.click(x=196, y=419)
time.sleep(1)
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'cur_balance_amount.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'cur_balance_amount', 'data_type']
...
comparison_columns = ['cur_balance_amount']
