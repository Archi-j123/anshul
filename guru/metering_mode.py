...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\metering_mode.py').read()) 
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'metering_mode.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'metering_mode', 'data_type']
...
comparison_columns = ['metering_mode']
