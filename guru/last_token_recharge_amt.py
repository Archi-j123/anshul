...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\last_token_recharge_amt.py').read()) 
...
# Click last_token_recharge_amt
pyautogui.click(x=187, y=370)
time.sleep(1)
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'last_token_recharge_amt.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'last_token_recharge_amt', 'data_type']
...
comparison_columns = ['last_token_recharge_amt']
