...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\tamper_count.py').read()) 
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'cumm_tamper_count.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'cumm_tamper_count', 'data_type']
...
comparison_columns = ['cumm_tamper_count']
