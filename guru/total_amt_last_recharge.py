...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\total_amt_last_recharge.py').read()) 
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'total_amt_last_recharge.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'total_amt_last_recharge', 'data_type']
...
comparison_columns = ['total_amt_last_recharge']
