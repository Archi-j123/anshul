...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\payment_mode.py').read()) 
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'payment_mode.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'payment_mode', 'data_type']
...
comparison_columns = ['payment_mode']
