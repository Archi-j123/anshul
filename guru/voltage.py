...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\voltage.py').read()) 
...
# Click resister  
pyautogui.click(x=54, y=135)
time.sleep(1)

# Click voltage 
pyautogui.click(x=146, y=277)
time.sleep(1)
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'voltage.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'voltage', 'data_type']
