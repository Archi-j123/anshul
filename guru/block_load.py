...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'block_load.xlsx')
...
headers_file1 = ['date', 'time', 'am/pm', 'avg_voltage', 'import_Wh',  'import_VAh', 'export_Wh', 'export_VAh','avg_current']

# Create DataFrame for data_guruX.txt
df_file1 = pd.DataFrame(parsed_data, columns=headers_file1)

# Convert relevant columns to numeric
for col in ['avg_voltage', 'import_VAh', 'export_VAh', 'import_Wh', 'export_Wh', 'avg_current']:
...
columns_file2 = ['import_VAh', 'export_VAh', 'import_Wh', 'export_Wh', 'avg_voltage', 'avg_current','index_no','temperature','data_type','total_packet']
...
comparison_columns = ['avg_voltage', 'import_VAh', 'export_VAh', 'import_Wh', 'export_Wh', 'avg_current']
