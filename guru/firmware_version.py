...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\firmware_version.py').read()) 
...
# Click firmware_version
pyautogui.click(x=183, y=659)
time.sleep(1)
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'firmware_version.xlsx')
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'firmware_version', 'data_type']
...
comparison_columns = ['firmware_version']
