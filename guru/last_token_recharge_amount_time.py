...
exec(open('C:\\Users\\krishankanty\\Desktop\\anshul\\data_preparation\\last_token_recharge_amount_time.py').read()) 
...
# Click last_token_recharge_time
pyautogui.click(x=193, y=386)
time.sleep(1)
...
output_file_path = os.path.join(os.getenv('USERPROFILE'), 'Downloads', 'last_token_recharge_time.xlsx')
...
headers_file1 = ['last_token_recharge_date', 'last_token_recharge_time', 'AM/PM']
...
df_file1['last_token_recharge_date'] = pd.to_datetime(df_file1['last_token_recharge_date'], format='%d-%m-%Y', errors='coerce')
df_file1['last_token_recharge_time'] = pd.to_datetime(df_file1['last_token_recharge_time'], format='%H:%M:%S', errors='coerce').dt.time
...
columns_file2 = ['date_time', 'meter_ip_address', 'command_name', 'last_token_recharge_date', 'last_token_recharge_time', 'data_type']
...
df_file2['file2_last_token_recharge_date'] = pd.to_datetime(df_file2['file2_last_token_recharge_date'], format='%d-%m-%Y', errors='coerce')
df_file2['file2_last_token_recharge_time'] = pd.to_datetime(df_file2['file2_last_token_recharge_time'], format='%H:%M:%S', errors='coerce').dt.time

# Step 3: Merge DataFrames
df_merged = pd.concat([df_file1, df_file2], axis=1)

# Step 4: Compare columns and create Result columns
comparison_columns = ['last_token_recharge_date', 'last_token_recharge_time']
