...
for line in log_data:
    ...
    last_token_match = re.search(r"cur_balance_time:\s*datetime\.datetime\(([^)]+)\)", line)
    ...
    # Process the cur_balance_time field if matched
    if last_token_match:
        ...
        try:
            ...
            row_data['cur_balance_date'] = last_token_date_obj.strftime("%d-%m-%Y")
            row_data['cur_balance_time'] = last_token_date_obj.strftime("%I:%M:%S")
        except ValueError:
            row_data['cur_balance_date'] = None
            row_data['cur_balance_time'] = None
